...
$id1 = $_SESSION['crfs'];
	$administrador_basico = "Administrador_Basico";
	$funcionario_comum = "Funcionario_Comum";
	$numero_login = $funcionario->getNumeroLogin();
	$funcionarios = FuncionarioDAO::todosExcetoEleMesmoAbaixaDeleMesmo($numero_login,$administrador_basico,$funcionario_comum);
